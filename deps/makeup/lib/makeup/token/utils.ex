  ...
  @hierarchy [
    ...
    {:comment, "c",
     [
       ...
       {:comment_preproc, "cp", [{:comment_preproc_file, "cpf"}]},
       {:comment_single, "c1"},
       {:comment_special, "cs"}
     ]},
    {:keyword, "k",
    ...
    {:literal, "l", [{:literal_date, "ld"}]},
    {:name, "n",
     [
       {:name_attribute, "na"},
       {:name_builtin, "nb", [{:name_builtin_pseudo, "bp"}]},
       {:name_class, "nc"},
       {:name_constant, "no"},
       {:name_decorator, "nd"},
       {:name_entity, "ni"},
       {:name_exception, "ne"},
       {:name_function, "nf", [{:name_function_magic, "fm"}]},
       {:name_property, "py"},
       {:name_label, "nl"},
       {:name_namespace, "nn"},
       {:name_other, "nx"},
    ...
    {:number, "m",
     [
       ...
       {:number_float, "mf"},
       {:number_hex, "mh"},
       {:number_integer, "mi", [{:number_integer_long, "il"}]},
       {:number_oct, "mo"}
     ]},
    {:string, "s",
     [
